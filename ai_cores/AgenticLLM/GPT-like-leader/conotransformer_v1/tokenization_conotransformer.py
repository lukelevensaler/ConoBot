...
class ConoTransformerTokenizer(PreTrainedTokenizer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ImportError(
                "You need to install sacremoses to use ConoTransformerTokenizer. "
    ...
    def build_inputs_with_special_tokens(
        ...
        adding special tokens. A ConoTransformer sequence has the following format:
...
__all__ = ["ConoTransformerTokenizer"]
